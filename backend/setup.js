...
const data = {
    users: [
        { id: "admin-001", name: "Admin User", username: "admin", email: "admin@college.edu", password: hash, role: "admin", departmentId: null },
        { id: "faculty-001", name: "Dr. Sharma", username: "sharma", email: "sharma@college.edu", password: hash, role: "faculty", departmentId: "dept-001" },
    ],
    departments: [
